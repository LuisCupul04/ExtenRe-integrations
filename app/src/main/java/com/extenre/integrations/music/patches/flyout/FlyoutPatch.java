...
package com.extenre.integrations.music.patches.flyout;
...
import static com.extenre.integrations.shared.utils.Utils.clickView;
...
import com.extenre.integrations.music.utils.VideoUtils;
...
public class FlyoutPatch {
    ...
    private static void replaceDismissQueue(@NonNull TextView textView, @NonNull ImageView imageView) {
        ...
        runOnMainThreadDelayed(() -> {
                    textView.setText(str("extenre_replace_flyout_menu_dismiss_queue_watch_on_youtube_label"));

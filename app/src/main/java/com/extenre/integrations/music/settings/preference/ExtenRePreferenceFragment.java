...
import static com.extenre.integrations.music.settings.Settings.BYPASS_IMAGE_REGION_RESTRICTIONS_DOMAIN;
import static com.extenre.integrations.music.settings.Settings.CHANGE_START_PAGE;
import static com.extenre.integrations.music.settings.Settings.CUSTOM_FILTER_STRINGS;
import static com.extenre.integrations.music.settings.Settings.CUSTOM_PLAYBACK_SPEEDS;
import static com.extenre.integrations.music.settings.Settings.EXTERNAL_DOWNLOADER_PACKAGE_NAME;
import static com.extenre.integrations.music.settings.Settings.HIDE_ACCOUNT_MENU_FILTER_STRINGS;
import static com.extenre.integrations.music.settings.Settings.OPEN_DEFAULT_APP_SETTINGS;
import static com.extenre.integrations.music.settings.Settings.OPTIONAL_SPONSOR_BLOCK_SETTINGS_PREFIX;
import static com.extenre.integrations.music.settings.Settings.RETURN_YOUTUBE_USERNAME_ABOUT;
import static com.extenre.integrations.music.settings.Settings.SB_API_URL;
import static com.extenre.integrations.music.settings.Settings.SETTINGS_IMPORT_EXPORT;
import static com.extenre.integrations.music.settings.Settings.SPOOF_APP_VERSION_TARGET;
...
import static com.extenre.integrations.shared.settings.BaseSettings.RETURN_YOUTUBE_USERNAME_DISPLAY_FORMAT;
import static com.extenre.integrations.shared.settings.BaseSettings.RETURN_YOUTUBE_USERNAME_YOUTUBE_DATA_API_V3_DEVELOPER_KEY;
import static com.extenre.integrations.shared.settings.Setting.getSettingFromPath;
...
import com.extenre.integrations.music.patches.utils.ReturnYouTubeDislikePatch;
import com.extenre.integrations.music.returnyoutubedislike.ReturnYouTubeDislike;
import com.extenre.integrations.music.settings.ActivityHook;
...
public class ExtenRePreferenceFragment extends PreferenceFragment {

    private static final String IMPORT_EXPORT_SETTINGS_ENTRY_KEY = "extenre_extended_settings_import_export_entries";
    ...
    public ExtenRePreferenceFragment() {
    }
    ...
    private void importExportListDialogBuilder() {
        try {
            ...
            getDialogBuilder(activity)
                    .setTitle(str("extenre_extended_settings_import_export_title"))
    ...
    private void importExportEditTextDialogBuilder() {
        try {
            ...
            getDialogBuilder(activity)
                    ...
                    .setView(container)
                    .setNegativeButton(android.R.string.cancel, null)
                    .setNeutralButton(str("extenre_extended_settings_import_copy"), (dialog, which) -> Utils.setClipboard(textView.getText().toString(), str("extenre_share_copy_settings_success")))
                    .setPositiveButton(str("extenre_extended_settings_import"), (dialog, which) -> importSettings(textView.getText().toString()))
                    .show();
        } catch (Exception ex) {
    ...
    private void exportText(Uri uri) {
        try {
            ...
            showToastShort(str("extenre_extended_settings_export_success"));
        } catch (IOException e) {
            showToastShort(str("extenre_extended_settings_export_failed"));
        }
    }
    ...
    private void importText(Uri uri) {
        ...
        try {
            ...
            showToastShort(str("extenre_extended_settings_import_failed"));

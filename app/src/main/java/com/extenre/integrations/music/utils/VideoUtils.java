...
import static com.extenre.integrations.music.settings.preference.ExternalDownloaderPreference.checkPackageIsEnabled;
...
import com.extenre.integrations.music.shared.VideoInformation;
...
public class VideoUtils extends IntentUtils {
    ...
    public static void openInYouTube() {
        ...
        if (videoId.isEmpty()) {
            showToastShort(str("extenre_replace_flyout_menu_dismiss_queue_watch_on_youtube_warning"));
            return;
        }

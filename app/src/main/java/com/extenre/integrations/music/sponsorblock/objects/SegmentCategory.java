...
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_FILLER;
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_FILLER_COLOR;
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_INTERACTION;
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_INTERACTION_COLOR;
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_INTRO;
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_INTRO_COLOR;
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_MUSIC_OFFTOPIC;
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_MUSIC_OFFTOPIC_COLOR;
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_OUTRO;
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_OUTRO_COLOR;
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_PREVIEW;
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_PREVIEW_COLOR;
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_SELF_PROMO;
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_SELF_PROMO_COLOR;
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_SPONSOR;
import static com.extenre.integrations.music.settings.Settings.SB_CATEGORY_SPONSOR_COLOR;
...
public enum SegmentCategory {
    SPONSOR("sponsor", sf("extenre_sb_segments_sponsor"), sf("extenre_sb_segments_sponsor_sum"), sf("extenre_sb_skip_button_sponsor"), sf("extenre_sb_skipped_sponsor"),
            SB_CATEGORY_SPONSOR, SB_CATEGORY_SPONSOR_COLOR),
    SELF_PROMO("selfpromo", sf("extenre_sb_segments_selfpromo"), sf("extenre_sb_segments_selfpromo_sum"), sf("extenre_sb_skip_button_selfpromo"), sf("extenre_sb_skipped_selfpromo"),
            SB_CATEGORY_SELF_PROMO, SB_CATEGORY_SELF_PROMO_COLOR),
    INTERACTION("interaction", sf("extenre_sb_segments_interaction"), sf("extenre_sb_segments_interaction_sum"), sf("extenre_sb_skip_button_interaction"), sf("extenre_sb_skipped_interaction"),
            SB_CATEGORY_INTERACTION, SB_CATEGORY_INTERACTION_COLOR),
    INTRO("intro", sf("extenre_sb_segments_intro"), sf("extenre_sb_segments_intro_sum"),
    ...
    OUTRO("outro", sf("extenre_sb_segments_outro"), sf("extenre_sb_segments_outro_sum"), sf("extenre_sb_skip_button_outro"), sf("extenre_sb_skipped_outro"),
            SB_CATEGORY_OUTRO, SB_CATEGORY_OUTRO_COLOR),
    PREVIEW("preview", sf("extenre_sb_segments_preview"), sf("extenre_sb_segments_preview_sum"),
    ...
    FILLER("filler", sf("extenre_sb_segments_filler"), sf("extenre_sb_segments_filler_sum"), sf("extenre_sb_skip_button_filler"), sf("extenre_sb_skipped_filler"),
            SB_CATEGORY_FILLER, SB_CATEGORY_FILLER_COLOR),
    MUSIC_OFFTOPIC("music_offtopic", sf("extenre_sb_segments_nomusic"), sf("extenre_sb_segments_nomusic_sum"), sf("extenre_sb_skip_button_nomusic"), sf("extenre_sb_skipped_nomusic"),

...
public class ExternalDownloaderPreference {
    ...
    private static final String[] mEntries = ResourceUtils.getStringArray("extenre_external_downloader_label");
    private static final String[] mEntryValues = ResourceUtils.getStringArray("extenre_external_downloader_package_name");
    private static final String[] mWebsiteEntries = ResourceUtils.getStringArray("extenre_external_downloader_website");

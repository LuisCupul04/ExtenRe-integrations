...
public class ExternalDownloaderVideoPreference extends Preference implements Preference.OnPreferenceClickListener {
    ...
    private static final String[] mEntries = ResourceUtils.getStringArray("extenre_external_downloader_video_label");
    private static final String[] mEntryValues = ResourceUtils.getStringArray("extenre_external_downloader_video_package_name");
    private static final String[] mWebsiteEntries = ResourceUtils.getStringArray("extenre_external_downloader_video_website");

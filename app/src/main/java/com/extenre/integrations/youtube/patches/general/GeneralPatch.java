package com.extenre.integrations.youtube.patches.general;
...
import static com.extenre.integrations.shared.utils.Utils.hideViewByLayoutParams;
import static com.extenre.integrations.shared.utils.Utils.hideViewGroupByMarginLayoutParams;
import static com.extenre.integrations.shared.utils.Utils.hideViewUnderCondition;
import static com.extenre.integrations.youtube.patches.utils.PatchStatus.ImageSearchButton;
...
public class GeneralPatch {
    ...
    private static void openRVXSettings(View view) {
        ...
        Intent intent = new Intent(Intent.ACTION_MAIN);
        intent.setPackage(context.getPackageName());
        intent.setData(Uri.parse("extenre_extended_settings_intent"));

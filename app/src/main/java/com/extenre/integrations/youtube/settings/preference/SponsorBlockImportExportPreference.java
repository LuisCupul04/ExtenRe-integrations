...
public class SponsorBlockImportExportPreference extends EditTextPreference implements Preference.OnPreferenceClickListener {
    ...
    private void init() {
        ...
        String importExportSummary = SponsorBlockSettings.userHasSBPrivateId()
                ? str("extenre_sb_settings_ie_sum_warning")
                : str("extenre_sb_settings_ie_sum");
    ...
    protected void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        try {
            ...
            builder.setNeutralButton(str("extenre_sb_settings_copy"), (dialog, which) ->
                            Utils.setClipboard(getEditText().getText().toString(), str("extenre_sb_share_copy_settings_success")))

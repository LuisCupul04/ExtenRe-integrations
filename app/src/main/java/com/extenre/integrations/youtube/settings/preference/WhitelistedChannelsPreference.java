...
import com.extenre.integrations.youtube.whitelist.VideoChannel;
import com.extenre.integrations.youtube.whitelist.Whitelist;
import com.extenre.integrations.youtube.whitelist.Whitelist.WhitelistType;
...
public class WhitelistedChannelsPreference extends Preference implements Preference.OnPreferenceClickListener {
    ...
    public static void showWhitelistedChannelDialog(Context context) {
        ...
        builder.setTitle(str("extenre_whitelist_settings_title"));
    ...
    private static void showWhitelistedChannelDialog(Context context, WhitelistType whitelistType) {
        ...
        if (mEntries.isEmpty()) {
            ...
            emptyView.setText(str("extenre_whitelist_empty"));
            ...
            for (final VideoChannel entry : mEntries) {
                ...
                View entryView = getEntryView(context, author, v -> new AlertDialog.Builder(context)
                        .setMessage(str("extenre_whitelist_remove_dialog_message", author, whitelistType.getFriendlyName()))

...
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_FILLER;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_FILLER_COLOR;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_HIGHLIGHT;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_HIGHLIGHT_COLOR;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_INTERACTION;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_INTERACTION_COLOR;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_INTRO;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_INTRO_COLOR;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_MUSIC_OFFTOPIC;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_MUSIC_OFFTOPIC_COLOR;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_OUTRO;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_OUTRO_COLOR;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_PREVIEW;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_PREVIEW_COLOR;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_SELF_PROMO;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_SELF_PROMO_COLOR;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_SPONSOR;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_SPONSOR_COLOR;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_UNSUBMITTED;
import static com.extenre.integrations.youtube.settings.Settings.SB_CATEGORY_UNSUBMITTED_COLOR;
...
public enum SegmentCategory {
    SPONSOR("sponsor", sf("extenre_sb_segments_sponsor"), sf("extenre_sb_skip_button_sponsor"), sf("extenre_sb_skipped_sponsor"),
            SB_CATEGORY_SPONSOR, SB_CATEGORY_SPONSOR_COLOR),
    SELF_PROMO("selfpromo", sf("extenre_sb_segments_selfpromo"), sf("extenre_sb_skip_button_selfpromo"), sf("extenre_sb_skipped_selfpromo"),
            SB_CATEGORY_SELF_PROMO, SB_CATEGORY_SELF_PROMO_COLOR),
    INTERACTION("interaction", sf("extenre_sb_segments_interaction"), sf("extenre_sb_skip_button_interaction"), sf("extenre_sb_skipped_interaction"),
            SB_CATEGORY_INTERACTION, SB_CATEGORY_INTERACTION_COLOR),
    /**
     * Unique category that is treated differently than the rest.
     */
    HIGHLIGHT("poi_highlight", sf("extenre_sb_segments_highlight"), sf("extenre_sb_skip_button_highlight"), sf("extenre_sb_skipped_highlight"),
            SB_CATEGORY_HIGHLIGHT, SB_CATEGORY_HIGHLIGHT_COLOR),
    INTRO("intro", sf("extenre_sb_segments_intro"),
            sf("extenre_sb_skip_button_intro_beginning"), sf("extenre_sb_skip_button_intro_middle"), sf("extenre_sb_skip_button_intro_end"),
            sf("extenre_sb_skipped_intro_beginning"), sf("extenre_sb_skipped_intro_middle"), sf("extenre_sb_skipped_intro_end"),
            SB_CATEGORY_INTRO, SB_CATEGORY_INTRO_COLOR),
    OUTRO("outro", sf("extenre_sb_segments_outro"), sf("extenre_sb_skip_button_outro"), sf("extenre_sb_skipped_outro"),
            SB_CATEGORY_OUTRO, SB_CATEGORY_OUTRO_COLOR),
    PREVIEW("preview", sf("extenre_sb_segments_preview"),
            sf("extenre_sb_skip_button_preview_beginning"), sf("extenre_sb_skip_button_preview_middle"), sf("extenre_sb_skip_button_preview_end"),
            sf("extenre_sb_skipped_preview_beginning"), sf("extenre_sb_skipped_preview_middle"), sf("extenre_sb_skipped_preview_end"),
            SB_CATEGORY_PREVIEW, SB_CATEGORY_PREVIEW_COLOR),
    FILLER("filler", sf("extenre_sb_segments_filler"), sf("extenre_sb_skip_button_filler"), sf("extenre_sb_skipped_filler"),
            SB_CATEGORY_FILLER, SB_CATEGORY_FILLER_COLOR),
    MUSIC_OFFTOPIC("music_offtopic", sf("extenre_sb_segments_nomusic"), sf("extenre_sb_skip_button_nomusic"), sf("extenre_sb_skipped_nomusic"),
            SB_CATEGORY_MUSIC_OFFTOPIC, SB_CATEGORY_MUSIC_OFFTOPIC_COLOR),
    UNSUBMITTED("unsubmitted", StringRef.empty, sf("extenre_sb_skip_button_unsubmitted"), sf("extenre_sb_skipped_unsubmitted"),
            SB_CATEGORY_UNSUBMITTED, SB_CATEGORY_UNSUBMITTED_COLOR),
    ;

    private static final StringRef skipSponsorTextCompact = sf("extenre_sb_skip_button_compact");
    private static final StringRef skipSponsorTextCompactHighlight = sf("extenre_sb_skip_button_compact_highlight");
    ...
    private void loadFromSettings() {
        ...
        CategoryBehaviour savedBehavior = CategoryBehaviour.byExTenReKeyValue(behaviorString);
    ...
    public void setBehaviour(@NonNull CategoryBehaviour behaviour) {
        ...
        this.behaviorSetting.save(behaviour.ExTenReKeyValue);
    }

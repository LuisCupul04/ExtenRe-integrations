...
package com.extenre.integrations.youtube.swipecontrols.views
...
import com.extenre.integrations.shared.utils.ResourceUtils.ResourceType
import com.extenre.integrations.shared.utils.ResourceUtils.getIdentifier
import com.extenre.integrations.shared.utils.StringRef.str
import com.extenre.integrations.youtube.swipecontrols.SwipeControlsConfigurationProvider
import com.extenre.integrations.youtube.swipecontrols.misc.SwipeControlsOverlay
import com.extenre.integrations.youtube.swipecontrols.misc.applyDimension
...
class SwipeControlsOverlayLayout(
    ...
    override fun onBrightnessChanged(brightness: Double) {
        if (config.shouldLowestValueEnableAutoBrightness && brightness <= 0) {
            showFeedbackView(
                str("extenre_swipe_lowest_value_auto_brightness_overlay_text"),
                autoBrightnessIcon,
            )

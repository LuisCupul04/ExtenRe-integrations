...
public class ThirdPartyYouTubeMusicPreference extends Preference implements Preference.OnPreferenceClickListener {
    ...
    private static final String[] mEntries = ResourceUtils.getStringArray("extenre_third_party_youtube_music_label");
    private static final String[] mEntryValues = ResourceUtils.getStringArray("extenre_third_party_youtube_music_package_name");
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        builder.setTitle(str("extenre_third_party_youtube_music_dialog_title"));
    ...
    private static void showToastOrOpenWebsites(Context context, String appName, String packageName) {
        ...
        Utils.showToastShort(str("extenre_third_party_youtube_music_not_installed_warning", appName.isEmpty() ? packageName : appName));
    }

...
public class SponsorSegment implements Comparable<SponsorSegment> {
    public enum SegmentVote {
        UPVOTE(sf("extenre_sb_vote_upvote"), 1, false),
        DOWNVOTE(sf("extenre_sb_vote_downvote"), 0, true),
        CATEGORY_CHANGE(sf("extenre_sb_vote_category"), -1, true); // apiVoteType is not used for category change

...
import static com.extenre.integrations.youtube.utils.ExtendedUtils.isFullscreenHidden;
...
import com.extenre.integrations.youtube.patches.player.PlayerPatch;
...
public class SponsorBlockViewController {
    ...
    public static void initialize(ViewGroup viewGroup) {
        try {
            ...
            LayoutInflater.from(context).inflate(getLayoutIdentifier("extenre_sb_inline_sponsor_overlay"), layout);
            ...
            skipHighlightButtonRef = new WeakReference<>(
                    Objects.requireNonNull(getChildView(layout, "extenre_sb_skip_highlight_button")));
            skipSponsorButtonRef = new WeakReference<>(
                    Objects.requireNonNull(getChildView(layout, "extenre_sb_skip_sponsor_button")));
            newSegmentLayoutRef = new WeakReference<>(
                    Objects.requireNonNull(getChildView(layout, "extenre_sb_new_segment_view")));

package com.extenre.integrations.youtube.returnyoutubedislike;

import static com.extenre.integrations.shared.returnyoutubedislike.ReturnYouTubeDislike.Vote;
...
import com.extenre.integrations.shared.returnyoutubedislike.requests.RYDVoteData;
import com.extenre.integrations.shared.returnyoutubedislike.requests.ReturnYouTubeDislikeApi;
    ...
    private static SpannableString createDislikeSpan(@NonNull Spanned oldSpannable,
        ...
        if (!Utils.containsNumber(oldLikes)) {
            if (Settings.RYD_ESTIMATED_LIKE.get()) {
                ...
                String hiddenMessageString = str("extenre_ryd_video_likes_hidden_by_video_owner");
    ...
    public void sendVote(@NonNull Vote vote) {
        ...
        try {
            if (isShort != PlayerType.getCurrent().isNoneOrHidden()) {
                ...
                Utils.showToastLong(str("extenre_ryd_failure_ryd_enabled_while_playing_video_then_user_voted"));
                return;
            }

...
import static com.extenre.integrations.shared.utils.ResourceUtils.getIdentifier;
...
public final class NewSegmentLayout extends FrameLayout {
    ...
    public NewSegmentLayout(final Context context, final AttributeSet attributeSet,
        ...
        LayoutInflater.from(context).inflate(getLayoutIdentifier("extenre_sb_new_segment"), this, true);
        ...
        initializeButton(
                context,
                "extenre_sb_new_segment_forward",
                () -> VideoInformation.seekToRelative(Settings.SB_CREATE_NEW_SEGMENT_STEP.get()),
        ...
        initializeButton(
                context,
                "extenre_sb_new_segment_compare",
        ...
        initializeButton(
                context,
                "extenre_sb_new_segment_publish",

...
import com.extenre.integrations.youtube.settings.preference.SponsorBlockSettingsPreference;
...
public class SponsorBlockSettings {
    ...
    public static void importDesktopSettings(@NonNull String json) {
        ...
        try {
            ...
            Utils.showToastLong(str("extenre_sb_settings_import_successful"));
        } catch (Exception ex) {
            Logger.printInfo(() -> "failed to import settings", ex); // use info level, as we are showing our own toast
            Utils.showToastLong(str("extenre_sb_settings_import_failed", ex.getMessage()));
        }
    }
    ...
    public static String exportDesktopSettings() {
        ...
        try {
            ...
            Utils.showToastLong(str("extenre_sb_settings_export_failed", ex));
            return "";
        }
    }
    ...
    public static void showExportWarningIfNeeded(@Nullable Context dialogContext) {
        ...
        if (dialogContext != null && SponsorBlockSettings.userHasSBPrivateId()
            ...
            new AlertDialog.Builder(dialogContext)
                    .setMessage(str("extenre_sb_settings_extenre_export_user_id_warning"))
                    .setNeutralButton(str("extenre_sb_settings_extenre_export_user_id_warning_dismiss"),

...
public class ImportExportPreference extends EditTextPreference implements Preference.OnPreferenceClickListener {
    ...
    protected void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        try {
            ...
            builder.setNeutralButton(str("extenre_extended_settings_import_copy"), (dialog, which) ->
                            Utils.setClipboard(getEditText().getText().toString(), str("extenre_share_copy_settings_success")))
                    .setPositiveButton(str("extenre_extended_settings_import"), (dialog, which) ->
    ...
    private void importSettings(String replacementSettings) {
        try {
            ...
            ExtenRePreferenceFragment.settingImportInProgress = true;
            ...
            ExtenRePreferenceFragment.settingImportInProgress = false;
        }
    }

...
public class ShortsPatch {
    ...
    static {
        ...
        final int bottomMargin = validateValue(
                ...
                0,
                64,
                "extenre_shorts_meta_panel_bottom_margin_invalid_toast"
        );
        ...
        final int heightPercentage = validateValue(
                ...
                0,
                100,
                "extenre_shorts_navigation_bar_height_percentage_invalid_toast"
        );
    ...
    private static final int zeroPaddingDimenId =
            ResourceUtils.getDimenIdentifier("extenre_zero_padding");

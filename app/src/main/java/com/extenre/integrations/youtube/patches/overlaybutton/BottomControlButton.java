...
import static com.extenre.integrations.shared.utils.ResourceUtils.getAnimation;
import static com.extenre.integrations.shared.utils.ResourceUtils.getInteger;
...
public abstract class BottomControlButton {
    ...
    public void changeSelected(boolean selected) {
        ...
        if (imageView.getColorFilter() == cf) {
            Utils.showToastShort(str("extenre_overlay_button_not_allowed_warning"));
            return;
        }

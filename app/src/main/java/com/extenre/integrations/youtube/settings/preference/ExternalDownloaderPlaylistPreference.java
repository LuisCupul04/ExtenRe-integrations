...
public class ExternalDownloaderPlaylistPreference extends Preference implements Preference.OnPreferenceClickListener {
    ...
    private static final String[] mEntries = ResourceUtils.getStringArray("extenre_external_downloader_playlist_label");
    private static final String[] mEntryValues = ResourceUtils.getStringArray("extenre_external_downloader_playlist_package_name");
    private static final String[] mWebsiteEntries = ResourceUtils.getStringArray("extenre_external_downloader_playlist_website");
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        builder.setTitle(str("extenre_external_downloader_dialog_title"));
        ...
        builder.setNeutralButton(str("extenre_extended_settings_reset"), (dialog, which) -> settings.resetToDefault());
    ...
    private static boolean showToastOrOpenWebsites(Context context, String appName, String packageName, String website) {
        ...
        if (website.isEmpty()) {
            Utils.showToastShort(str("extenre_external_downloader_not_installed_warning", packageName));
            return false;
        }

        new AlertDialog.Builder(context)
                .setTitle(str("extenre_external_downloader_not_installed_dialog_title"))
                .setMessage(str("extenre_external_downloader_not_installed_dialog_message", appName, appName))

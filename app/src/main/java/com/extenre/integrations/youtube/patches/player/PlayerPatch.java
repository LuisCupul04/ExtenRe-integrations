package com.extenre.integrations.youtube.patches.player;

import static com.extenre.integrations.shared.utils.Utils.hideViewBy0dpUnderCondition;
import static com.extenre.integrations.shared.utils.Utils.hideViewByRemovingFromParentUnderCondition;
...
import com.extenre.integrations.youtube.patches.utils.InitializationPatch;
...
public class PlayerPatch {
    ...
    static {
        final int opacity = validateValue(
                ...
                0,
                100,
                "extenre_custom_player_overlay_opacity_invalid_toast"
        );
        ...
        SPEED_OVERLAY_VALUE = validateValue(
                ...
                0.0f,
                8.0f,
                "extenre_speed_overlay_value_invalid_toast"
        );
        ...
        final int topMargin = validateValue(
                ...
                0,
                32,
                "extenre_quick_actions_top_margin_invalid_toast"
        );

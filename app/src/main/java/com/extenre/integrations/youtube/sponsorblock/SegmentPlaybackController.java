...
import static com.extenre.integrations.youtube.utils.VideoUtils.getFormattedTimeStamp;
...
import com.extenre.integrations.youtube.shared.VideoState;
        ...
        Utils.runOnMainThreadDelayed(() -> {
            try {
                ...
                Utils.showToastShort(toastNumberOfSegmentsSkipped == 1
                        ...
                        : str("extenre_sb_skipped_multiple_segments"));
            } catch (Exception ex) {

...
package com.extenre.integrations.youtube.patches.alternativethumbnails;

import static com.extenre.integrations.shared.utils.StringRef.str;
import static com.extenre.integrations.youtube.settings.Settings.ALT_THUMBNAIL_HOME;
import static com.extenre.integrations.youtube.settings.Settings.ALT_THUMBNAIL_LIBRARY;
import static com.extenre.integrations.youtube.settings.Settings.ALT_THUMBNAIL_PLAYER;
import static com.extenre.integrations.youtube.settings.Settings.ALT_THUMBNAIL_SEARCH;
import static com.extenre.integrations.youtube.settings.Settings.ALT_THUMBNAIL_SUBSCRIPTIONS;
import static com.extenre.integrations.youtube.shared.NavigationBar.NavigationButton;
...
import com.extenre.integrations.youtube.shared.RootView;
...
public final class AlternativeThumbnailsPatch {
    ...
    private static Uri validateSettings() {
        ...
        if (scheme == null || scheme.equals("http") || apiUri.getHost() == null) {
            Utils.showToastLong(str("extenre_alt_thumbnail_dearrow_api_url_invalid_toast"));
            Utils.showToastShort(str("extenre_extended_reset_to_default_toast"));
        ...
        if (timeToResumeDeArrowAPICalls < now) {
            ...
            if (Settings.ALT_THUMBNAIL_DEARROW_CONNECTION_TOAST.get()) {
                String toastMessage = (statusCode != 0)
                        ? str("extenre_alt_thumbnail_dearrow_error", statusCode)
                        : str("extenre_alt_thumbnail_dearrow_error_generic");

...
import static com.extenre.integrations.youtube.utils.ExtendedUtils.isSpoofingToLessThan;

import android.preference.Preference;
import android.preference.SwitchPreference;

import com.extenre.integrations.shared.settings.Setting;
import com.extenre.integrations.youtube.patches.general.LayoutSwitchPatch;
import com.extenre.integrations.youtube.patches.general.MiniplayerPatch;
import com.extenre.integrations.youtube.patches.utils.PatchStatus;
import com.extenre.integrations.youtube.patches.utils.ReturnYouTubeDislikePatch;
import com.extenre.integrations.youtube.returnyoutubedislike.ReturnYouTubeDislike;
...
public class ExtenReSettingsPreference extends ExtenRePreferenceFragment {
    ...
    public static void initializeExtenReSettings() {
    ...
    private static void RYDPreferenceLinks() {
        ...
        String shortsSummary = ReturnYouTubeDislikePatch.IS_SPOOFING_TO_NON_LITHO_SHORTS_PLAYER
                ? str("extenre_ryd_shorts_summary_on")
                : str("extenre_ryd_shorts_summary_on_disclaimer");
    ...
    private static void WhitelistPreferenceLinks() {
        ...
        final String[] whitelistKey = {Settings.OVERLAY_BUTTON_WHITELIST.key, "extenre_whitelist_settings"};

...
public class SpoofStreamingDataSideEffectsPreference extends Preference {
    ...
    private void updateUI() {
        ...
        if (clientType == ClientType.IOS && Settings.SPOOF_STREAMING_DATA_IOS_SKIP_LIVESTREAM_PLAYBACK.get()) {
            summaryTextKey = "extenre_spoof_streaming_data_side_effects_ios_skip_livestream_playback";
        } else {
            summaryTextKey = "extenre_spoof_streaming_data_side_effects_" + clientType.name().toLowerCase();
        }

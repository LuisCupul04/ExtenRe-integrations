...
public class WatchHistoryStatusPreference extends Preference {
    ...
    private final SharedPreferences.OnSharedPreferenceChangeListener listener = (sharedPreferences, str) -> {
        // Because this listener may run before the ExtenRe settings fragment updates Settings,
    ...
    private void updateUI() {
        ...
        if (blockWatchHistory) {
            summaryTextKey = "extenre_watch_history_about_status_blocked";
        } else if (replaceWatchHistory) {
            summaryTextKey = "extenre_watch_history_about_status_replaced";
        } else {
            summaryTextKey = "extenre_watch_history_about_status_original";
        }

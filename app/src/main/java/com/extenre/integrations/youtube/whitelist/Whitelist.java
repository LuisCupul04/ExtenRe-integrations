...
public class Whitelist {
    ...
    private static final String whitelistIncluded = str("extenre_whitelist_included");
    private static final String whitelistExcluded = str("extenre_whitelist_excluded");
    ...
    static {
        ...
        final int sponsorBlockDrawableId = ResourceUtils.getDrawableIdentifier("extenre_sb_logo");
    ...
    public static void showWhitelistDialog(Context context) {
        ...
        if (channelId.isEmpty() || channelName.isEmpty()) {
            Utils.showToastShort(str("extenre_whitelist_failure_generic"));
            return;
        }
    ...
    private static void addToWhitelist(WhitelistType whitelistType, String channelId, String channelName) {
        ...
        if (updateWhitelist(whitelistType, whitelisted)) {
            showToastShort(str("extenre_whitelist_added", channelName, friendlyName));
        } else {
            showToastShort(str("extenre_whitelist_add_failed", channelName, friendlyName));
        }
    }
    ...
    public static void removeFromWhitelist(WhitelistType whitelistType, String channelId) {
        ...
        String friendlyName = whitelistType.getFriendlyName();
        if (updateWhitelist(whitelistType, whitelisted)) {
            showToastShort(str("extenre_whitelist_removed", channelName, friendlyName));
        } else {
            showToastShort(str("extenre_whitelist_remove_failed", channelName, friendlyName));
        }
    }
    ...
    public enum WhitelistType {
        ...
        WhitelistType() {
            ...
            this.friendlyName = str("extenre_whitelist_" + name);

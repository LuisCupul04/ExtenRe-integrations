...
package com.extenre.integrations.shared.settings.preference;
...
public abstract class AbstractPreferenceFragment extends PreferenceFragment {
    ...
    protected void initialize() {
        final int id = getXmlIdentifier("extenre_prefs");
    ...
    public static void showRestartDialog(@NonNull final Context context) {
        if (restartDialogMessage == null) {
            restartDialogMessage = str("extenre_extended_restart_message");
        }
